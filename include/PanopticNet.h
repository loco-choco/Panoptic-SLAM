...
class PanopticNet {
private:
  PyObject *py_module;    /*!< Module of python where the Mask algorithm is
                             implemented */
  ...
  PyThreadState *py_lock;

  std::string py_path;     /*!< Path to be included to the environment variable
                              PYTHONPATH */
...
public:
  ...
  void ShortTerm_DA(std::vector<Panoptic_Object> &objs,
